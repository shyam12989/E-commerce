function FooterBottom(){
    ...
    return(
        ...
        <hr></hr> 
        <div>   
        <h4 style={{textAlign:"left", color:"black"}}>Contact Us:</h4>
        <div className="FooterAlignment">Email Address: <u>customercare@shoppersmart.com</u></div>
        <div style={{textAlign:"left",color:"black"}}>Phone Number: 9865432107</div>
        </div>
